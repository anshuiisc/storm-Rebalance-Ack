...
import org.apache.storm.starter.storm.spouts.SampleSpout;
...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial2", new fooXMLParserStateful("2"), 1).shuffleGrouping("spout");
        builder.setBolt("fooPartial3", new fooXMLParserStateful("3"), 1).shuffleGrouping("fooPartial2");
        builder.setBolt("fooPartial4", new fooXMLParserStateful("4"), 1).shuffleGrouping("fooPartial3");
        builder.setBolt("fooPartial5", new fooXMLParserStateful("5"), 1).shuffleGrouping("fooPartial4");
        builder.setBolt("fooPartial6", new fooXMLParserStateful("6"), 1).shuffleGrouping("fooPartial5");
        builder.setBolt("fooPartial7", new fooXMLParserStateful("7"), 1).shuffleGrouping("fooPartial6");
        builder.setBolt("fooPartial8", new fooXMLParserStateful("8"), 1).shuffleGrouping("fooPartial7");


        builder.setBolt("fooPartial9", new fooXMLParserStateful("9"), 1).shuffleGrouping("fooPartial4");

        builder.setBolt("fooPartial10", new fooXMLParserStateful("10"), 1).shuffleGrouping("fooPartial9");
        builder.setBolt("fooPartial11", new fooXMLParserStateful("11"), 1).shuffleGrouping("fooPartial9");
        builder.setBolt("fooPartial12", new fooXMLParserStateful("12"), 1).shuffleGrouping("fooPartial9");
        builder.setBolt("fooPartial13", new fooXMLParserStateful("13"), 1).shuffleGrouping("fooPartial12");

        builder.setBolt("fooPartial14", new fooXMLParserStateful("14"), 3)
                .shuffleGrouping("fooPartial10")
                .shuffleGrouping("fooPartial11")
                .shuffleGrouping("fooPartial13");

        builder.setBolt("fooPartial15", new fooXMLParserStateful("15"), 3).shuffleGrouping("fooPartial14");
        builder.setBolt("fooPartial16", new fooXMLParserStateful("16"), 3).shuffleGrouping("fooPartial15");
