...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial4", new fooSleep("4"), 2).shuffleGrouping("fooPartial2").shuffleGrouping("fooPartial3");
        builder.setBolt("fooPartial5", new fooSleep("5"), 2).shuffleGrouping("fooPartial4");
        builder.setBolt("fooPartial6", new fooSleep("6"), 2).shuffleGrouping("fooPartial4");

        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("fooPartial5").shuffleGrouping("fooPartial6");
